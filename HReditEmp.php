                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" name="id_card_number_emp" id="id_card_number_emp" class="form-control"
                            value="<?php echo $row['id_card_number_emp']; ?>" >
                    </div>
                    <br>
                    <div class="col-10">
