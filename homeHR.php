...
<body>
    ...
    <div class="leftcolumn">
        ...
        <div class="d-flex flex-column flex-shrink-0 p-3 bg-body-tertiary"
            ...
            <ul class="nav nav-pills flex-column mb-auto">
                <li class="nav-item">
                    <a href="homeHR.php" class="nav-link active" aria-current="page"
    ...
    <div class="rightcolumn">
        ...
        <div class="wrapper">
            <form action="homeHR.php" method="GET"> <!-- ใช้หน้าเดียวกัน (index.php) เป็น action -->
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    if (isset($_GET['keyword'])) {
                        ...
                        $sql = "SELECT id_emp, email_emp, tel_emp, name_emp, jobtitle_emp, address_emp, status_emp FROM employees WHERE id_emp LIKE '%$keyword%' OR name_emp LIKE '%$keyword%'";
                    } else {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td>
                <a href="HRallDataEmp.php?id=' . $row['id_emp'] . '" 
                class="btn btn-sm btn-primary" style="width: 100px ";>แสดงข้อมูลเพิ่มเติม</a> |
